...
let about = [
  ...
  '<br>',
  `<span class="color2">· Senior Full Stack Engineer with 4+ years of experience.</span>`,
  `<span class="color2">· Currently at <span class="command">SigNoz (YC W21)</span> — observability infrastructure at scale.</span>`,
  `<span class="color2">· Core stack: <span class="command">Go · React · TypeScript · Next.js · OpenTelemetry</span></span>`,
  `<span class="color2">· Focus on performance optimization, scalable APIs, and complex data-driven UIs.</span>`,
